          ...
          <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
              ...
              <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item leftdaohang" data-url="${pageContext.request.contextPath}/QuestServlet?method=quest&workplace=${workplace}&code=${code}" mytitle="需求填表1"><a>需求填表1</a></li>
                
                <li class="layui-nav-item leftdaohang" data-url="${pageContext.request.contextPath}/tablesettle.jsp?workplace=${workplace}" mytitle="需求管理2"><a>需求管理2</a></li>
              </ul>
            </div>
          </div>
          <!--3.右侧主体内容区-->
