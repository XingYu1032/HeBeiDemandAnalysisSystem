...
public class register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(guhua+chuanzhen);
		
		/*
		 * System.out.println(uname); System.out.println(pwd); System.out.println(pwds);
		 * System.out.println(jigou); System.out.println(jigoucode);
		 * System.out.println(address); System.out.println(wangzhi);
		 * System.out.println(email); System.out.println(stand);
		 * System.out.println(postcode); System.out.println(lianxiren);
		 * System.out.println(phone); System.out.println(types);
		 * System.out.println(bumen); System.out.println(desc);
		 */
